...
ORDERER_ORG_NAME=$7
ORDERER_ORG_DOMAIN=$8

CHAINCODE_PACKAGE_PATH="/tmp/ticken-pv/chaincodes/${ORG_NAME}/${CHAINCODE_NAME}.tgz"
...
export CORE_PEER_TLS_ROOTCERT_FILE=/orgs/peer-orgs/${ORG_NAME}/nodes/${ORG_NODE}.${ORG_DOMAIN}/tls/ca.crt
...
peer lifecycle chaincode approveformyorg \
  ...
  --tls --cafile  /orgs/ord-orgs/${ORDERER_ORG_NAME}/nodes/ord0.${ORDERER_ORG_DOMAIN}/tls/signcerts/cert.pem
