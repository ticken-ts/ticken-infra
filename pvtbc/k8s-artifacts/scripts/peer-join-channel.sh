...
JOINING_ORG_NODE=$2
JOINING_ORG_NAME=$3
JOINING_ORG_DOMAIN=$4

ORDERER_ORG_NAME=$5
ORDERER_ORG_DOMAIN=$6

export CORE_PEER_TLS_ENABLED=true
export CORE_PEER_LOCALMSPID="${JOINING_ORG_NAME}MSP"
export CORE_PEER_ADDRESS=${JOINING_ORG_NAME}-${JOINING_ORG_NODE}:7051
export CORE_PEER_MSPCONFIGPATH=/orgs/peer-orgs/${JOINING_ORG_NAME}/users/Admin@${JOINING_ORG_DOMAIN}/msp
export CORE_PEER_TLS_ROOTCERT_FILE=/orgs/peer-orgs/${JOINING_ORG_NAME}/nodes/${JOINING_ORG_NODE}.${JOINING_ORG_DOMAIN}/tls/ca.crt
