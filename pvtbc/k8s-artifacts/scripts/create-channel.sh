...
osnadmin channel join \
  ...
  --ca-file         ./orgs/ord-orgs/${ORDERER_ORG_NAME}/nodes/ord0.${ORDERER_ORG_NAME}/tls/signcerts/cert.pem \
  --client-cert     ./orgs/ord-orgs/${ORDERER_ORG_NAME}/users/Admin@${ORDERER_ORG_NAME}/msp/signcerts/cert.pem \
  --client-key      ./orgs/ord-orgs/${ORDERER_ORG_NAME}/users/Admin@${ORDERER_ORG_NAME}/msp/keystore/priv.pem \
  --channelID       ${CHANNEL_NAME} \
